...
const Slide = ({ children, prev, next, welcome, end, ...rest }) => {
    return (
        <div className='flex flex-col items-center h-screen justify-center gap-[20px]'>
            {
                !welcome ?
                    <button onClick={prev} className='bg-[#191919] rounded-md shadow-md text-white w-[100px] h-[45px]'>
            ...
            {
                !end ?
                    <button onClick={next} className='bg-[#191919] rounded-md shadow-md text-white w-[100px] h-[45px]'>
